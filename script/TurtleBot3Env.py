...
'''
    LK:
    Turtlebot 3 Robot Envrironment implementation for OpenAI
    code taken from https://bitbucket.org/theconstructcore/openai_ros
    minor modifications and fixes applied
    as of now no camera feed is subscribed and passed to Task environment
'''
